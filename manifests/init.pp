...
class openstack (
  ...
  if $use_hiera {
    class { '::openstack::config':
      ...
      network_external_bridge         => hiera(openstack::network::external::bridge, $network_external_bridge),
      network_external_device         => hiera(openstack::network::external::device, undef),
      ...
      storage                         => hiera(openstack::storage, undef),
      ...
      controller_keepalived_address   => hiera(openstack::controller::keepalived_address, undef),
      controller_keepalived_pass      => hiera(openstack::controller::keepalived_pass, undef),
      controller_keepalived_router_id => hiera(openstack::controller::keepalived_router_id, undef),
      ...
      neutron_instance_mtu            => hiera(openstack::neutron::neutron_instance_mtu, $neutron_instance_mtu),
      neutron_path_mtu                => hiera(openstack::neutron::neutron_path_mtu, $neutron_path_mtu),
    ...
    class { '::openstack::config':
      ...
      neutron_path_mtu                => $neutron_path_mtu,
