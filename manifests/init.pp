...
class openstack (
  ...
  if $use_hiera {
    class { '::openstack::config':
      ...
      ssl_cacert                      => lookup(openstack::ssl::cacert, String, 'first', undef),
      ssl_cert                        => lookup(openstack::ssl::cert, String, 'first', undef),
      ssl_key                         => lookup(openstack::ssl::key, String, 'first', undef),
      ...
      network_external_bridge         => lookup(openstack::network::external::bridge, String, 'first', $network_external_bridge),
      network_external_device         => lookup(openstack::network::external::device, String, 'first', undef),
      ...
      network_neutron_private         => lookup(openstack::network::neutron::private, String, 'first', undef),
      controllers                     => lookup(openstack::controllers, Hash, 'first', undef),
      storage                         => lookup(openstack::storage, Hash, 'first', undef),
      controller_address_api          => lookup(openstack::controller::address::api, String, 'first', undef),
      controller_address_management   => lookup(openstack::controller::address::management, String, 'first', undef),
      controller_keepalived_address   => lookup(openstack::controller::keepalived_address, String, 'first', undef),
      controller_keepalived_pass      => lookup(openstack::controller::keepalived_pass, String, 'first', undef),
      controller_keepalived_router_id => lookup(openstack::controller::keepalived_router_id, Integer, 'first', undef),
      storage_address_api             => lookup(openstack::storage::address::api, String, 'first', undef),
      storage_address_management      => lookup(openstack::storage::address::management, String, 'first', undef),
      ...
      mysql_user_keystone             => pick(lookup(openstack::mysql::keystone::user, String, 'first', undef), 'keystone'),
      mysql_pass_keystone             => pick(lookup(openstack::mysql::keystone::pass, String, 'first', undef), lookup(openstack::mysql::service_password)),
      mysql_user_cinder               => pick(lookup(openstack::mysql::cinder::user, String, 'first', undef), 'cinder'),
      mysql_pass_cinder               => pick(lookup(openstack::mysql::cinder::pass, String, 'first', undef), lookup(openstack::mysql::service_password)),
      mysql_user_glance               => pick(lookup(openstack::mysql::glance::user, String, 'first', undef), 'glance'),
      mysql_pass_glance               => pick(lookup(openstack::mysql::glance::pass, String, 'first', undef), lookup(openstack::mysql::service_password)),
      mysql_user_nova                 => pick(lookup(openstack::mysql::nova::user, String, 'first', undef), 'nova'),
      mysql_pass_nova                 => pick(lookup(openstack::mysql::nova::pass, String, 'first', undef), lookup(openstack::mysql::service_password)),
      mysql_user_nova_api             => pick(lookup(openstack::mysql::nova_api::user, String, 'first', undef), 'nova_api'),
      mysql_pass_nova_api             => pick(lookup(openstack::mysql::nova_api::pass, String, 'first', undef), lookup(openstack::mysql::service_password)),
      mysql_user_neutron              => pick(lookup(openstack::mysql::neutron::user, String, 'first', undef), 'neutron'),
      mysql_pass_neutron              => pick(lookup(openstack::mysql::neutron::pass, String, 'first', undef), lookup(openstack::mysql::service_password)),
      mysql_user_heat                 => pick(lookup(openstack::mysql::heat::user, String, 'first', undef), 'heat'),
      mysql_pass_heat                 => pick(lookup(openstack::mysql::heat::pass, String, 'first', undef), lookup(openstack::mysql::service_password)),
      ...
      neutron_instance_mtu            => lookup(openstack::neutron::neutron_instance_mtu, Integer, 'first', $neutron_instance_mtu),
      ...
      horizon_servername              => lookup(openstack::horizon::servername, String, 'first', undef),
